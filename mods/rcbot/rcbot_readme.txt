RCBot Readme v1.3
=-------------------------------=
e-mail: cheeseh(at)rcbot(dot)net
=-------------------------------=
Website: http://www.rcbot.net
...
You can also kick bots from the game by using the waypoint menu.
...
ii.  Check the rcbot forum (http://www.rcbot.net/forums) for current bug reports made
...
also check out http://www.rcbot.net/credits.htm for more credits.

Missed you out? Email!